...
public class AppOrderNegativeTest {
    ...
    public void shouldNotSubmitWithEmptyName() {
        ...
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+78009008090");
    ...
    @Test
    public void shouldNotAcceptLatinLettersInName() {
    ...
    @Test
    public void shouldNotAcceptInvalidPhone() {
    ...
    @Test
    public void shouldBeFailedUncheckCheckbox(){
        driver.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Иванов Иван Иванович");
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+78009008090");
        driver.findElement(By.cssSelector(".button")).click();
